...
- Tổng hợp bằng chứng thực nghiệm: [docs/experiment_journal_spec.md](docs/experiment_journal_spec.md#L640)
...
Tổng hợp trong [docs/experiment_journal_spec.md](docs/experiment_journal_spec.md#L640):

- Failure A objective-side.
- B1 và B2 đều là thật.
- Late polish từ L4 không đáng tin cậy: [docs/experiment_journal_spec.md](docs/experiment_journal_spec.md#L647).
- Hướng hợp lý: intervene from epoch 0, center-aware full run: [docs/experiment_journal_spec.md](docs/experiment_journal_spec.md#L691), [docs/experiment_journal_spec.md](docs/experiment_journal_spec.md#L754).

## 8) Caveat thống kê và cách diễn giải

- Pooled center bundle trong Failure B suite có kích thước nhỏ (`n = 22`): [docs/experiment_journal_spec.md](docs/experiment_journal_spec.md#L140).
