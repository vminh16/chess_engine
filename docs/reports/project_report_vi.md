...
- nhánh cũ: [model/architecture](../../model/architecture)
- nhánh mới đang được dùng để nghiên cứu: [model/architecture_v2](../../model/architecture_v2)

---

## 3. Biểu diễn đầu vào

Tệp chính: [representation/encode.py](../../representation/encode.py)
...
- [train/train.ipynb](../../train/train.ipynb)
...
- [loss_function_design.md](../design/loss_function_design.md)
...
- [model/architecture_v2/model.py](../../model/architecture_v2/model.py)
- [model/architecture_v2/blocks.py](../../model/architecture_v2/blocks.py)
- [model/architecture_v2/head.py](../../model/architecture_v2/head.py)
...
Mỗi block trong [blocks.py](../../model/architecture_v2/blocks.py) chia feature theo channel thành hai nhánh:
...
Head hiện tại trong [head.py](../../model/architecture_v2/head.py) đã sửa so với head cũ.
...
- [search/negamax.py](../../search/negamax.py)
...
Theo [training_audit_report.md](./training_audit_report.md), phiên bản notebook cũ từng có vấn đề:
