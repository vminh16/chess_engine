...
Head hiện tại trong [model/architecture/head.py](C:/Users/USER/OneDrive/Máy tính/chess_engine/model/architecture/head.py) có dạng:
...
Đây là phương án được vẽ trong [docs/dgrn_value_head_redesign.drawio](C:/Users/USER/OneDrive/Máy tính/chess_engine/docs/dgrn_value_head_redesign.drawio).
